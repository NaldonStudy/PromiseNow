...
export const dummyMessages: ChatMessageResponse[] = [
  // 🟢 같은 사람, 같은 시간, 여러 메시지
  {
    ...
    roomUserId: 1,
    nickname: '지현',
    sendDate: '2025-08-05T08:00:00.000Z',
    type: 'TEXT',
    imageUrl: null,
  },
  {
  ...
  // 🟢 같은 사람, 시간 다름
  {
    ...
    roomUserId: 1,
    nickname: '지현',
    sendDate: '2025-08-05T08:03:00.000Z',
    type: 'TEXT',
    imageUrl: null,
  },
  ...
  // 🔵 다른 사람, 다른 시간, 이미지
  {
    ...
    roomUserId: 2,
    nickname: 'gpt',
    sendDate: '2025-08-05T08:05:00.000Z',
    type: 'IMAGE',
  ...
  // 🟢 다시 지현, 시간 다름
  {
    ...
    roomUserId: 1,
    nickname: '지현',
    sendDate: '2025-08-05T08:06:00.000Z',
    type: 'TEXT',
    imageUrl: null,
  },
  ...
  // 🔵 gpt, 같은 시간에 2개
  {
    ...
    roomUserId: 2,
    nickname: 'gpt',
    sendDate: '2025-08-05T08:10:00.000Z',
    type: 'TEXT',
    imageUrl: null,
  },
  {
